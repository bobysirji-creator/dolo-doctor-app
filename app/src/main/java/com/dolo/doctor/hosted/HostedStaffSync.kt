...
data class HostedStaffSnapshot(val role:HostedStaffRole,val permissions:Set<String>,val clinic:HostedClinic,val sessions:List<HostedSession>,val appointments:List<HostedAppointment>,val queues:List<HostedQueue>,val assistants:List<HostedAssistant>)
